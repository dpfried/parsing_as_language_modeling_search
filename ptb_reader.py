...
# modified from Dyer et al RNNG code, https://github.com/clab/rnng
...
def remove_dev_unk(gold_parse, sys_parse):
    gold_tags, gold_tokens, gold_lowercase = get_tags_tokens_lowercase(gold_parse)
    sys_tags, sys_tokens, sys_lowercase = get_tags_tokens_lowercase(sys_parse)
